...
const Recover: FC<RecoveryProps> = props => {
  const { handleBack, handleCloseButton, handleOptions, depositAddress, senderChainInfo, node } = props;
          ...
          <ModalBody>
            <Stack column={true} spacing={5}>
              <Text fontSize="1rem" lineHeight="24px">
                Uh oh! Send the wrong asset to the deposit address? Fill out the details below to attempt recovery of
                your assets from the state channels.
              </Text>
              <Box>
                <Stack column={true} spacing={5}>
                  ...
                  <Button
                    ...
                    onClick={() => recover(recoverTokenAddress, recoverWithdrawalAddress)}
                  >
                    Recover
                  </Button>
                </Stack>
